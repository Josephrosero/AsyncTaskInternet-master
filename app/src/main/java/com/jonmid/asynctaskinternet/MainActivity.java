...
import com.jonmid.asynctaskinternet.Adapter.CommentasAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    List <Comment> commentList; // se guardan los 500m regsitros
    CommentasAdapter commentasAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView= (RecyclerView) findViewById(R.id.recicler_item);
...
commentasAdapter = new CommentasAdapter(commentList,getApplicationContext());
        recyclerView.setAdapter(commentasAdapter);
    }
